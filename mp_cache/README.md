...
machine problem. For a more comprehensive summary, see [GUIDE.md](./GUIDE.md). For a discussion of our _optional_ competion, see [COMPETITION.md](./COMPETITION.md).**
...
provided in `rtl/cache.sv`. All other arrays must be implemented using D
...
- `rtl/*.sv`: You are free to modify provided files and add more files in this directory.
- `rtl/svbuild.yaml`

> as described in [COMPETITION.md](./COMPETITION.md), the modified `configs/config.yaml` file should also be pushed into the competition branch if you intend to participate.
